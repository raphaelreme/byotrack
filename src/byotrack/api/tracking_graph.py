...
class TrackingGraph(nx.DiGraph):
    ...
    * merge: True if the edge represents a merge
    ...
    def from_tracks(tracks: Collection[byotrack.Track]) -> TrackingGraph:  # noqa: C901, PLR0912
        ...
        for track in tracks:
            ...
            if edge in trk_graph.edges:  # Already added as a split
                assert trk_graph.edges[edge]["split"]  # noqa: S101
    ...
    def from_nx(  # noqa: D417, PLR0913
        ...
        *,
        ...
        for edge in nx_graph.edges:
            # Check we move forward in time. It also ensures there is no cycle in the graph
    ...
    def to_tracks(self) -> list[byotrack.Track]:
        ...
        tracks = []
        for segment, identifier in zip(segments, segment_ids, strict=True):
