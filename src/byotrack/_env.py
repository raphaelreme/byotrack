...
def parse_bool_from_env(key: str, *, default: bool) -> bool:
    ...
    warnings.warn(
        f"Environment variable {key} expects a boolean value (found {value}) => Defaults to {default}.", stacklevel=2
    )
    return default
...
NUMBA_CACHE = parse_bool_from_env("NUMBA_CACHE", default=True)
