...
The script `link.py` expects as input the data path to the data folder, the name of the dataset inside the data folder and the sequence to link in the dataset.
